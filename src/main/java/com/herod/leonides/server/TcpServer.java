...
public class TcpServer {
    ...
    private final static int PORT_DEFAULT = 10403;
...
/* ********  C O N S T R U C T O R S  ******** */
    ...
    public TcpServer( int port, InetAddress inetAddress ) throws UnknownHostException {
        this.port = port;
        this.currentState = ServerState.STOPPED;
...
/* ********  R U N N I N G  ******** */
    ...
    protected void runServer(){
        try{
            this.tcpServer = new ServerSocket( getPort(), 50, getServerAddress() );                 // Create server
...
/* ********  P O R T  ******** */
    ...
    public synchronized void setPort( int port ){
        ...
        this.port = port;
        if( getState() == ServerState.STARTED && oldVal != port ){
            reset();
        }   // end if: is running
...
//    public class Adapter implements Listener {
        ...
        /**
         * Empty call for {@link Listener#tcpServerStateChanged}.
         * @param evt the event
         */
      //  public void tcpServerStateChanged(Event evt) {}
        ...
        /**
         * Empty call for {@link Listener#socketReceived}.
         * @param evt the event
         */
